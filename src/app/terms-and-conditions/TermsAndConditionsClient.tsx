    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
          ...
          <div className="prose prose-gray max-w-none prose-headings:text-gray-900 prose-p:text-gray-700 prose-li:text-gray-700 prose-a:text-blue-600 hover:prose-a:text-blue-800 prose-strong:text-gray-900">
            <h2 className="text-xl font-bold mt-12 mb-4">
              AGREEMENT TO OUR LEGAL TERMS
            </h2>
            <p>
              We are Shenzhen Rapid Direct Co., Ltd, doing business as
              RapidDirect and RD (&ldquo;Company,&rdquo; &ldquo;we,&rdquo;
              &ldquo;us,&rdquo; &ldquo;our&rdquo;), a company registered in
              China at Building A12, Haosi Industrial Park, Nanpu Road, Xinqiao
              Street, Bao&apos;an District, Nanpu Road, Xinqiao Street,
              Bao&apos;an District, Shenzhen, Guangdong 518104. Our VAT number
              is 91440300MA5FKB6QXE.
            </p>
            <p>
              We operate the website{" "}
              <a
                href="https://www.rapiddirect.com"
                target="_blank"
                rel="noopener noreferrer"
              >
                https://www.rapiddirect.com
              </a>{" "}
              (the &ldquo;Site&rdquo;), as well as any other related products
              and services that refer or link to these legal terms (the
              &ldquo;Legal Terms&rdquo;) (collectively, the
              &ldquo;Services&rdquo;).
            </p>
            <p>
              You can contact us by phone at (+86)13302480516, email at{" "}
              <a href="mailto:support@rapiddirect.com">
                support@rapiddirect.com
              </a>
              , or by mail to Building A12, Haosi Industrial Park, Nanpu Road,
              Xinqiao Street, Bao&apos;an District, Nanpu Road, Xinqiao Street,
              Bao&apos;an District, Shenzhen, Guangdong 518104, China.
            </p>
            <p>
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity
              (&ldquo;you&rdquo;), and Shenzhen Rapid Direct Co., Ltd,
            ...
            <p>
              ...
              &ldquo;Last updated&rdquo; date of these Legal Terms, and you
            ...
            <h2 className="text-xl font-bold mt-12 mb-4">TABLE OF CONTENTS</h2>
            <ol className="list-decimal">
              <li><a href="#tc-section-1">OUR SERVICES</a></li>
              <li><a href="#tc-section-2">INTELLECTUAL PROPERTY RIGHTS</a></li>
              <li><a href="#tc-section-3">USER REPRESENTATIONS</a></li>
              <li><a href="#tc-section-4">USER REGISTRATION</a></li>
              <li><a href="#tc-section-5">PURCHASES AND PAYMENT</a></li>
              <li><a href="#tc-section-6">POLICY</a></li>
              <li><a href="#tc-section-7">PROHIBITED ACTIVITIES</a></li>
              <li><a href="#tc-section-8">USER GENERATED CONTRIBUTIONS</a></li>
              <li><a href="#tc-section-9">CONTRIBUTION LICENSE</a></li>
              <li><a href="#tc-section-10">GUIDELINES FOR REVIEWS</a></li>
              <li><a href="#tc-section-11">THIRD-PARTY WEBSITES AND CONTENT</a></li>
              <li><a href="#tc-section-12">SERVICES MANAGEMENT</a></li>
              <li><a href="#tc-section-13">PRIVACY POLICY</a></li>
              <li><a href="#tc-section-14">COPYRIGHT INFRINGEMENTS</a></li>
              <li><a href="#tc-section-15">TERM AND TERMINATION</a></li>
              <li><a href="#tc-section-16">MODIFICATIONS AND INTERRUPTIONS</a></li>
              <li><a href="#tc-section-17">GOVERNING LAW</a></li>
              <li><a href="#tc-section-18">DISPUTE RESOLUTION</a></li>
              <li><a href="#tc-section-19">CORRECTIONS</a></li>
              <li><a href="#tc-section-20">DISCLAIMER</a></li>
              <li><a href="#tc-section-21">LIMITATIONS OF LIABILITY</a></li>
              <li><a href="#tc-section-22">INDEMNIFICATION</a></li>
              <li><a href="#tc-section-23">USER DATA</a></li>
              <li><a href="#tc-section-24">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
              <li><a href="#tc-section-25">CALIFORNIA USERS AND RESIDENTS</a></li>
              <li><a href="#tc-section-26">MISCELLANEOUS</a></li>
              <li><a href="#tc-section-27">CONTACT US</a></li>
            </ol>

            {/* Section 1 */}
            <h2 id="tc-section-1" className="text-xl font-bold mt-12 mb-4">
              1. OUR SERVICES
            </h2>
            <p>
            ...
            {/* Section 2 */}
            <h2 id="tc-section-2" className="text-xl font-bold mt-12 mb-4">
            ...
            <p>
              ...
              Marks and ensure that any copyright or proprietary notice appears
            ...
            <p>
              ...
              Services (&ldquo;Submissions&rdquo;), you agree to assign to us
            ...
            <p>
              ...
              information, or other material (&ldquo;Contributions&rdquo;). Any
            ...
            <p>
              ...
              refer to the &ldquo;COPYRIGHT INFRINGEMENTS&rdquo; section below.
            </p>

            {/* Section 3 */}
            <h2 id="tc-section-3" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 4 */}
            <h2 id="tc-section-4" className="text-xl font-bold mt-12 mb-4">
              4. USER REGISTRATION
            </h2>
            <p>
            ...
            {/* Section 5 */}
            <h2 id="tc-section-5" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 6 */}
            <h2 id="tc-section-6" className="text-xl font-bold mt-12 mb-4">
              6. POLICY
            </h2>
            <p>
            ...
            {/* Section 7 */}
            <h2 id="tc-section-7" className="text-xl font-bold mt-12 mb-4">
            ...
            <ul>
              ...
              <li>
                ...
                referred to as &ldquo;spyware&rdquo; or &ldquo;passive
            ...
            {/* Section 8 */}
            <h2 id="tc-section-8" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 9 */}
            <h2 id="tc-section-9" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 10 */}
            <h2 id="tc-section-10" className="text-xl font-bold mt-12 mb-4">
            ...
            <p>
              ...
              (7) you may not post any false or misleading statements; and (8)
            ...
            {/* Section 11 */}
            <h2 id="tc-section-11" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 12 */}
            <h2 id="tc-section-12" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 13 */}
            <h2 id="tc-section-13" className="text-xl font-bold mt-12 mb-4">
              13. PRIVACY POLICY
            </h2>
            <p>
            ...
            {/* Section 14 */}
            <h2 id="tc-section-14" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 15 */}
            <h2 id="tc-section-15" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 16 */}
            <h2 id="tc-section-16" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 17 */}
            <h2 id="tc-section-17" className="text-xl font-bold mt-12 mb-4">
              17. GOVERNING LAW
            </h2>
            <p>
              These Legal Terms shall be governed by and defined following the
              laws of China. Shenzhen Rapid Direct Co., Ltd and yourself
              irrevocably consent that the courts of China shall have exclusive
              jurisdiction to resolve any dispute which may arise in connection
              with these Legal Terms.
            </p>

            {/* Section 18 */}
            <h2 id="tc-section-18" className="text-xl font-bold mt-12 mb-4">
            ...
            <p>
              ...
              or arbitration shall be Shenzhen, China. The language of the
              proceedings shall be Simplified Chinese. The governing law of these
              Legal Terms shall be substantive law of China.
            </p>
            ...
            {/* Section 19 */}
            <h2 id="tc-section-19" className="text-xl font-bold mt-12 mb-4">
              19. CORRECTIONS
            </h2>
            <p>
            ...
            {/* Section 20 */}
            <h2 id="tc-section-20" className="text-xl font-bold mt-12 mb-4">
              20. DISCLAIMER
            </h2>
            <p>
            ...
            {/* Section 21 */}
            <h2 id="tc-section-21" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 22 */}
            <h2 id="tc-section-22" className="text-xl font-bold mt-12 mb-4">
              22. INDEMNIFICATION
            </h2>
            <p>
            ...
            {/* Section 23 */}
            <h2 id="tc-section-23" className="text-xl font-bold mt-12 mb-4">
              23. USER DATA
            </h2>
            <p>
            ...
            {/* Section 24 */}
            <h2 id="tc-section-24" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 25 */}
            <h2 id="tc-section-25" className="text-xl font-bold mt-12 mb-4">
            ...
            {/* Section 26 */}
            <h2 id="tc-section-26" className="text-xl font-bold mt-12 mb-4">
              26. MISCELLANEOUS
            </h2>
            <p>
            ...
            {/* Section 27 */}
            <h2 id="tc-section-27" className="text-xl font-bold mt-12 mb-4">
              27. CONTACT US
            </h2>
            <p>
            ...
            <p>
              ...
              <br />
              Building A12, Haosi Industrial Park, Nanpu Road, Xinqiao Street,
              Bao&apos;an District
              <br />
