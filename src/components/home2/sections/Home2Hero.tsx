      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 min-h-[calc(100vh-80px)] flex items-center">
        <div className="grid grid-cols-12 gap-8 w-full py-20">
          ...
          >
            ...
            <h1
              className="text-[48px] md:text-[64px] lg:text-[80px] font-bold text-white leading-[0.95] tracking-tight uppercase mb-2"
            ...
            <h1
              className="text-[48px] md:text-[64px] lg:text-[80px] font-bold text-[#D09947] leading-[0.95] tracking-tight uppercase mb-8"
              style={{ fontFamily: "var(--font-archivo)" }}
            >
              Built to Last
            </h1>
            ...
            <p
              className="text-[#7A7A7C] text-lg max-w-xl mb-10 leading-relaxed"
              ...
              <ul className="space-y-5 mb-8 relative">
                {features.map((feature, index) => (
                  <li key={index} className="flex items-center gap-4">
                    ...
                    >
                      <span
                        className="text-[#D09947] font-semibold"
                        style={{ fontFamily: "var(--font-mono)" }}
                      >
                        {feature.highlight}
                      </span>{" "}
              ...
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-[#D09947]/20">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center">
                    <div
                      className="text-[#D09947] text-2xl font-bold"
                      style={{ fontFamily: "var(--font-archivo)" }}
                    >
                      {stat.value}
                    </div>
                    <div
                      className="text-[#7A7A7C] text-[10px] uppercase tracking-wider"
                      style={{ fontFamily: "var(--font-jakarta)" }}
                    >
                      {stat.label}
                    </div>
