      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 min-h-[calc(100vh-80px)] flex items-center">
        <div className="grid grid-cols-12 gap-8 w-full py-20">
          ...
          >
            ...
            <h1 className="text-[30px] sm:text-[44px] md:text-[64px] lg:text-[80px] font-bold text-white leading-[0.95] tracking-tight uppercase mb-2">
              Precision
            </h1>
            <h1 className="text-[30px] sm:text-[44px] md:text-[64px] lg:text-[80px] font-bold text-white leading-[0.95] tracking-tight uppercase mb-2">
              Manufacturing,
            </h1>
            <h1 className="text-[30px] sm:text-[44px] md:text-[64px] lg:text-[80px] font-bold text-[#D09947] leading-[0.95] tracking-tight uppercase mb-8">
              Built to Last
            </h1>
