...
const DEFAULTS = {
  ...
  heading: "Start Your Custom Overmolding Project",
  description:
    "Upload your CAD files and tell us the substrate material, overmold material, target hardness, expected volume, and functional requirements. Our engineers will review material compatibility, part geometry, tooling options, validation needs, and production risks before recommending the next step.",
  primaryCta: "Upload Your Design",
  secondaryCta: "Talk to an Engineer",
};

export function OMCTA() {
  return (
