...
const DEFAULTS = {
  ...
  subheading:
    "ApexBatch supports overmolding applications where the second material must improve grip, sealing, protection, insulation, strain relief, impact resistance, or assembly performance.",
  parts: [
    {
      title: "Automotive Control Components",
      description:
        "Overmolded knobs and interior control surfaces combine rigid plastic structures with durable grip zones for secure operation, vibration control, and repeated handling.",
      tags: ["Secure Grip", "Vibration Control", "Wear Resistance"],
      image:
        "https://apex-batch-images.s3.us-east-1.amazonaws.com/services/injection-molding/3-custom-injection-molding-solutions.webp",
    },
    {
      title: "Consumer Electronics Housings",
      description:
        "Soft-touch housings and protective frames improve grip, cushion frequently handled edges, and maintain clean material boundaries across handheld and connected devices.",
      tags: ["Soft Touch", "Edge Protection", "Boundary Control"],
      image:
    ...
    },
    {
      ...
      description:
        "Overmolded teach pendants and operator control housings add secure handling, impact protection, and vibration control for equipment used in demanding production environments.",
      tags: ["Secure Handling", "Impact Protection", "Vibration Control"],
      image:
    ...
    },
    {
      ...
      description:
        "Overmolded housings for handheld diagnostic and monitoring equipment provide ergonomic grip, cushioning, and controlled sealing interfaces for frequent, precise operation.",
      tags: ["Ergonomic Grip", "Cushioning", "Sealing"],
      image:
    ...
    {
      title: "Charging Equipment Housings",
      description:
        "Overmolded charging handles and control housings provide secure grip, sealed exterior interfaces, and impact protection for equipment exposed to repeated handling and variable environments.",
      tags: ["Secure Grip", "Sealing", "Impact Protection"],
      image:
    ...
    {
      title: "UAV Control Housings",
      description:
        "Overmolded ground-control housings add secure grip, edge protection, and vibration control for UAV equipment requiring lightweight construction and reliable field handling.",
      tags: ["Secure Grip", "Edge Protection", "Vibration Control"],
      image:
