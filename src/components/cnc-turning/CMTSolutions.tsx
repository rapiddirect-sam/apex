...
const DEFAULTS = {
  ...
  subheading: "From prototype validation to repeat batch delivery, ApexBatch supports custom CNC Turning projects with DFM review, tolerance control, material coordination, surface finishing, inspection, and flexible production planning.",
  solutions: [
    {
    ...
    },
    {
      ...
      description:
        "For projects with many part numbers and smaller quantities, we coordinate CNC Turning, materials, surface finishes, inspection requirements, and delivery schedules under one flexible production plan.",
