...
const DEFAULTS = {
  eyebrow: "CNC Turning for Low-to-Mid Volume Production",
  titlePrefix: "",
  titleHighlight: "CNC Turning Services",
  titleSuffix: " for Precision Turned Parts",
  description:
    "Upload your CAD files and drawings online for free DFM feedback, tolerance review, and a detailed CNC turning quote within 24 hours. ApexBatch supports 2-axis, live-tool, and Swiss-type CNC turning for custom turned parts, with standard tolerances to ±0.05 mm and selected tight tolerances reviewed down to ±0.01 mm.",
    ...
    <section className="relative bg-[#060606] pt-16 overflow-hidden">
      <div className={`absolute inset-0${isEditMode ? " z-[1]" : ""}`}>
        <EditableImage
          ...
          alt="Custom CNC Turning Services"
          fill
          priority
          fetchPriority="high"
