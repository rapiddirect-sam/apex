...
const DEFAULTS = {
  ...
  headingSuffix: " for CNC Turning",
  subheading:
    "Small design details such as corner radii, undercuts, thread forms, wall thickness, and length-to-diameter ratios can affect CNC turning cost, tolerance stability, and production risk. ApexBatch reviews CAD files and drawings before production to identify manufacturability issues early.",
  guidelinesData: [
    {
      element: "Corner / Fillet Radius",
      recommended: "\u2265 0.3 mm on internal transitions",
    },
    {
      element: "Threaded Features (\u00D81.5\u20135 mm)",
      recommended: "M1.6\u2013M5, depth \u2264 2 \u00D7 diameter",
    },
    {
      element: "Threaded Features (\u2265 \u00D8 5 mm)",
      recommended: "M6 or larger; blind or through threads available",
    },
    {
      element: "Grooves & Undercuts",
      recommended: "Avoid sharp internal corners; specify accessible tool geometry",
    },
    {
      element: "Length-to-Diameter Ratio",
      recommended: "Keep L/D \u2264 10 where possible for best concentricity",
    },
    {
      element: "Wall Thickness",
      recommended: "Metals \u2265 0.5 mm; plastics \u2265 1 mm on thin sections",
    },
  ],
};

export function CMTDesignGuidelines() {
  return (
    <section
