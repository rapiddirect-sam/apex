...
const DEFAULTS = {
  ...
  reasons: [
    ...
    },
    {
      ...
      description: "From single prototypes to 500+ production runs. Perfect balance of ultra-precision machining and cost-effective solutions for rapid R&D iteration.",
    ...
    },
    {
      ...
      description: "Complete workflow from design to delivery. Support for expedited production, batch scheduling, and custom delivery solutions under one roof.",
    ...
    },
    {
      ...
      description: "Dedicated sales + engineering teams, visual order management, compliance adaptation, and risk analysis. 24-hour rapid response with professional support.",
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_1.4fr] gap-x-10 gap-y-8">
          {/* Features */}
          {DEFAULTS.reasons.map((reason, index) => {
            const gridProps = index < 2 ? {} : {};
            return (
              <motion.div
                key={reason.title}
                ...
                style={{ padding: "20px 0", gridColumn: index === 2 || index === 3 ? undefined : undefined }}
              >
          ...
          >
            ...
            <p style={{ fontSize: "14px", lineHeight: 1.6, color: "#FFFFFF", marginBottom: "28px" }}>
            ...
            <div className="flex items-center justify-center gap-2 mt-5" style={{ fontSize: "12px", color: "#6B7280" }}>
