...
const DEFAULTS = {
  headingHighlight: "Extrusion Manufacturing ",
  ...
  description2:
    "We support end-to-end manufacturing in one location, including CNC machining, precision extrusion, sheet metal fabrication, 3D printing, as well as in-house surface treatment and quality inspection lines.",
  stats: [
  ...
  images: [
    {
      ...
      alt: "Extrusion Factory Workshop",
    },
    {
      ...
      alt: "Plastic Extrusion Production Line",
    },
    {
      ...
      alt: "Custom Extrusion Manufacturing Facility",
    },
    {
      ...
      alt: "Extrusion Machines On Site",
    },
    {
      ...
      alt: "Plastic Extrusion Factory",
    },
  ],
};

export function EXSupplier() {
