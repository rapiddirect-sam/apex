...
const DEFAULTS = {
  ...
  subheading: "See the CNC milling, inspection, finishing, and delivery support behind ApexBatch's high-precision manufacturing workflow.",
  items: [
    {
