...
const DEFAULTS = {
  ...
  headingHighlight: "CNC Milled Parts",
  headingSuffix: " We Support",
  subheading: "Representative CNC milled parts for aerospace, medical equipment, automotive, and precision industrial applications—built with material selection, tolerance control, surface finishing, and inspection support.",
  parts: [
    {
      title: "Aerospace / UAV Structural Parts",
      description: "Lightweight CNC milled aluminum structures with pockets, mounting features, and tight feature alignment for stable assembly performance.",
      tags: ["Material: 7075 / 6061 Aluminum", "Focus: Lightweight Structure", "Process: 5-Axis Milling"],
      image: "https://apex-batch-images.s3.us-east-1.amazonaws.com/services/cnc-machining/4-UAV-structural components.webp",
    },
    {
      title: "Automation Equipment Components",
      description: "CNC milled brackets, fixtures, and positioning parts for automation systems that require stable assembly, repeatable dimensions, and reliable batch delivery.",
      tags: ["Material: Aluminum / Stainless Steel", "Focus: Assembly Accuracy", "Process: 3-Axis / 4-Axis Milling"],
      image: "https://apex-batch-images.s3.us-east-1.amazonaws.com/services/cnc-machining/4-Medical-Device Housing.webp",
    },
    {
      title: "Medical Equipment Housings",
      description: "Precision CNC milled housings and structural parts for medical equipment, with material selection, corrosion resistance, clean surface requirements, and inspection support.",
      tags: ["Material: 316 Stainless Steel / Aluminum", "Focus: Medical-Grade Cleanliness", "Process: CNC Milling"],
      image: "https://apex-batch-images.s3.us-east-1.amazonaws.com/services/cnc-machining/4-Automotive Sensor Mount.webp",
    },
    {
      title: "Automotive Sensor Mounts",
      description: "CNC milled mounting parts with threaded features, datum surfaces, and finish requirements for automotive and new energy applications.",
      tags: ["Material: 6061 Aluminum / Stainless Steel", "Focus: Mounting Accuracy", "Process: CNC Milling"],
      image: "https://apex-batch-images.s3.us-east-1.amazonaws.com/services/cnc-machining/4-Automotive Sensor Mount.webp",
    },
    {
      title: "Electronics & Enclosure Parts",
      description: "CNC milled aluminum housings, covers, and heat dissipation parts with cosmetic finish, threaded features, and assembly requirements.",
      tags: ["Material: 6061 Aluminum / 5052 Aluminum", "Focus: Appearance & Assembly", "Process: 3-Axis / 4-Axis Milling"],
      image: "https://apex-batch-images.s3.us-east-1.amazonaws.com/services/cnc-machining/4-Automotive Sensor Mount.webp",
    },
    {
      title: "Industrial Fixtures & Precision Plates",
      description: "CNC milled plates, bases, and fixtures with hole patterns, flatness requirements, and repeatable machining strategies for industrial equipment.",
      tags: ["Material: Aluminum / Tool Steel", "Focus: Flatness & Hole Position", "Process: 3-Axis Milling"],
      image: "https://apex-batch-images.s3.us-east-1.amazonaws.com/services/cnc-machining/4-Automotive Sensor Mount.webp",
    },
  ],
};

export function CMMParts() {
  return (
    <section
