...
const DEFAULTS = {
  ...
  subheading:
    "ApexBatch provides custom CNC milling services from engineering review and production planning to machining, finishing, inspection, and repeat batch delivery.",
