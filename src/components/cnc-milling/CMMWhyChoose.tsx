  ...
  slides: [
    {
      ...
      description:
        "Before production, ApexBatch reviews CAD files, drawings, materials, tolerances, and application requirements to identify machining risks, reduce revision cycles, and prepare a reliable CNC milling quote.",
    },
    {
      ...
      description:
        "For high-mix low-volume projects or repeat batch orders, ApexBatch coordinates CNC milling, materials, surface finishes, inspection requirements, and delivery schedules under one production plan.",
    },
    {
      ...
      description:
        "From material selection to CNC milling, surface finishing, inspection, packaging, and delivery, ApexBatch helps reduce supplier handoffs and communication gaps.",
    },
    {
