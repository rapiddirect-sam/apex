...
import { CNC_HERO_IMAGE_QUALITY, CNC_HERO_IMAGE_SIZES } from "@/lib/heroImageDefaults";
...
const DEFAULTS = {
  titlePrefix: "Custom ",
  titleHighlight: "Insert Molding Services",
  titleSuffix: "",
  description:
  ...
  metrics: [
    { value: "Free DFM", label: "Reduce tooling risk" },
    { value: "Insert Versatility", label: "Threads, terminals & more" },
    { value: "Plastic + Silicone", label: "LSR & solid silicone" },
    { value: "Repeatable Batches", label: "Built for repeat orders" },
  ],
};

export function InsHero() {
    ...
    <section className="relative bg-[#060606] pt-16 overflow-hidden">
      <div className={`absolute inset-0${isEditMode ? " z-[1]" : ""}`}>
        <EditableImage
          ...
          alt="Custom Insert Molding Services"
          fill
          priority
          fetchPriority="high"
