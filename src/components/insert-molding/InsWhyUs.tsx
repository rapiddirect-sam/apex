...
const DEFAULTS = {
  ...
  ctaText:
    "Share your drawings and quality requirements. Our team can review the inspection, functional testing, and repeat-production needs for your insert-molded parts.",
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6">
            ...
            >
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    <EditableText
                      path={`whyUs.slides.${currentSlide}.number`}
                  ...
                  >
                    <EditableText
                      path={`whyUs.slides.${currentSlide}.title`}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    >
                      <EditableText
                        path={`whyUs.slides.${currentSlide}.description`}
              ...
              {DEFAULTS.slides.map((slide, index) => (
                <button
                  ...
                  style={{
                    borderRadius: "8px",
                    border:
                      index === currentSlide ? "1px solid #D09947" : "1px solid rgba(208,153,71,0.25)",
        ...
        >
          ...
          >
            <EditableText path="whyUs.ctaText" defaultValue={DEFAULTS.ctaText} />
          </p>
          <Link
            href="/contact"
            rel="nofollow"
