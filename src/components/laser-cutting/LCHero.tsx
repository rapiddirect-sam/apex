...
const DEFAULTS = {
  ...
  description:
    "Get precision laser cut parts in aluminum, stainless steel, carbon steel, brass, and copper. ApexBatch reviews your drawings for material thickness, cut features, edge requirements, and secondary operations before providing a production-ready quote.",
  heroImage: LASER_CUTTING_HERO_DEFAULT_SRC,
  ...
  metrics: [
    { value: "Free DFM Feedback", label: "Optimize cut paths before production" },
    { value: "±0.1 mm Contour Precision", label: "Consistent edge quality on sheet parts" },
    { value: "20+ Sheet Materials", label: "Metals supported for laser cutting" },
    ...
    <section className="relative bg-[#060606] pt-16 overflow-hidden">
      <div className={`absolute inset-0${isEditMode ? " z-[1]" : ""}`}>
        <EditableImage
          ...
          alt="Custom Laser Cutting Services"
          fill
          priority
          fetchPriority="high"
