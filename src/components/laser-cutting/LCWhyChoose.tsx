...
const DEFAULTS = {
  ...
  ctaText: "Get Free Engineering Review Before Laser Cutting",
  ctaButton: "Contact Our Engineers",
  slides: [
    {
      image: getImageUrl("home/4-why-choose-us-1.webp"),
      number: "01",
      title: "Engineering Review Before Cutting",
      description:
        "We review material, thickness, kerf-sensitive features, hole sizes, bend relationships, tolerances, and finish requirements before production. This helps identify avoidable manufacturing risks while the design can still be adjusted.",
    },
    {
      ...
      description:
        "From first-article validation to high-mix, low-volume orders and repeat production, we plan material, nesting, inspection, and delivery around the needs of the complete part family.",
    },
    {
      image: getImageUrl("home/4-why-choose-us-3.webp"),
      number: "03",
      title: "One-Stop Sheet Metal Support",
      description:
        "Keep laser cutting, deburring, bending, welding, hardware insertion, surface finishing, marking, and assembly within one coordinated manufacturing workflow.",
    },
    {
      image: getImageUrl("home/4-why-choose-us-4.webp"),
      number: "04",
      title: "Quality Control Across the Order",
      description:
        "Incoming material checks, first-article inspection, in-process monitoring, and final verification help maintain critical dimensions, edge condition, appearance, and traceability.",
    },
  ],
};
