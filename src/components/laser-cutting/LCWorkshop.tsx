...
const DEFAULTS = {
  ...
  subheading:
    "See the laser cutting, inspection, secondary fabrication, and delivery support behind ApexBatch's precision sheet metal manufacturing workflow.",
  items: [
    {
      title: "Laser Cutting Workshop",
      image:
        "https://apex-batch-images.s3.us-east-1.amazonaws.com/about/6-Laser-Cutting-Systems.webp",
    },
    {
      title: "Fiber Laser Cutting Area",
      image:
    ...
    {
      title: "Bending & Secondary Operations",
      image:
  ...
  return (
    ...
    >
      <div className="relative min-h-[360px] h-full overflow-hidden">
        <EditableImage
          path={`workshop.items.${index}.image`}
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-5 pointer-events-none">
          ...
          >
            <EditableText path={`workshop.items.${index}.title`} defaultValue={item.title} />
          </h3>
        </div>
      </div>
    </article>
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          >
            <EditableText path="workshop.heading" defaultValue={DEFAULTS.heading} />
            <span style={{ color: "#EEC569" }}>
              <EditableText path="workshop.headingHighlight" defaultValue={DEFAULTS.headingHighlight} />
            </span>
          </h2>
          <p
          ...
          >
            <EditableText path="workshop.subheading" defaultValue={DEFAULTS.subheading} multiline />
          </p>
        </motion.div>
          ...
          <div className="relative overflow-hidden" style={{ height: "380px" }}>
            {DEFAULTS.items.map((item, index) => {
              ...
              return (
                ...
                >
                  <WorkshopCard item={item} index={index} isActive={isActive} />
                </motion.button>
              );
            })}
          </div>
